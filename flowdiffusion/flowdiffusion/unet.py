...
## ---------------------------------------------
## Copy from the AVDC directory, two code must be aligned
## ----------- Luo Custom, May 13 --------------
## ---------------------------------------------

class UnetThor_Luo(nn.Module):
    '''Luo's custom model when trained by Luo'''
    def __init__(self):
        super(UnetThor_Luo, self).__init__()
        self.unet = UNetModel(
            image_size=(128, 128),
            in_channels=6,
            model_channels=128,
...
class Unet_Libero(nn.Module):
    def __init__(self):
        super(Unet_Libero, self).__init__()
        self.unet = UNetModel(
            image_size=(128, 128),
            in_channels=6,
            model_channels=128,
